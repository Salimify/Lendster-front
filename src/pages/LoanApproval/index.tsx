...
interface LoanApprovalProps {
  ...
  loanApproval: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    loanApproval,
    loading: loading.effects['loanApproval/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'loanApproval/fetchBasic',
    });
  }

  render() {
    const { loanApproval, loading } = this.props;
    const { basicGoods, basicProgress } = loanApproval;
